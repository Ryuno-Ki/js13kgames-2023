...
export const CHECK_ON_GAMEOVER_CONDITION_ACTION = 'C'
/** Action type to check whether conditions for navigating to win are met */
export const CHECK_ON_WIN_CONDITION_ACTION = 'D'
/** Action type for deleting a save game */
export const DELETE_GAME_ACTION = 'E'
...
export const FORWARD_TO_NEXT_MONTH_ACTION = 'F'
/** Action type to load a game from localStorage */
export const LOAD_GAME_ACTION = 'G'
/** Action type to load a good onto a ship */
export const LOAD_SHIP_ACTION = 'H'
