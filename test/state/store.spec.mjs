...
describe('store', function () {
  ...
  describe('when player navigates to a new scene', function () {
    ...
    describe('when that scene is level', function () {
      ...
      describe('when the view is docks', function () {
        it('should include Docks of Lübeck in the title', async function () {
        // Arrange
        // Nothing to prepare
          ...
          // Assert
          expect(document.title).to.equal('Docks of Lübeck | The Baltic League | js13kgames-2023')
        })
      })
      ...
      describe('when the view is market', function () {
        it('should include Market of Lübeck in the title', async function () {
        // Arrange
        // Nothing to prepare
          ...
          // Assert
          expect(document.title).to.equal('Market of Lübeck | The Baltic League | js13kgames-2023')
        })
      })
